...
function addOrSubtractSomeValues(a, b, c){
    if(opr === '-'){
...
addOrSubtractSomeValues(value1, value2, opr)


// I ALSO TRIED WRITING IT USING A SWITCH STATEMENT. THEY ARE NOT EXACTLY THE SAME. JUST PRACTICING!


function calculator(var1, var2, op){
  switch (op){
    case '+':
